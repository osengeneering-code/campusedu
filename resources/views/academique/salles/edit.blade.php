            ...
            <form action="{{ route('academique.salles.update', $salle) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select @error('type_salle') is-invalid @enderror" id="type_salle" name="type_salle">
                        ...
                        <option value="Salle de cours" {{ old('type_salle', $salle->type_salle) == 'Salle de cours' ? 'selected' : '' }}>Salle de cours</option>
                        <option value="Laboratoire" {{ old('type_salle', $salle->type_salle) == 'Laboratoire' ? 'selected' : '' }}>Laboratoire</option>
                        <option value="Amphithéâtre" {{ old('type_salle', $salle->type_salle) == 'Amphithéâtre' ? 'selected' : '' }}>Amphithéâtre</option>
                        <option value="Salle de réunion" {{ old('type_salle', $salle->type_salle) == 'Salle de réunion' ? 'selected' : '' }}>Salle de réunion</option>
