...
<div class="container-fluid">
    ...
    <div class="card shadow-sm mb-4">
        <img src="{{ $ue->semestre->parcours->filiere->image_path }}" class="card-img-top" alt="Bannière de {{ $ue->semestre->parcours->filiere->nom }}" style="max-height: 250px; object-fit: cover;">
    </div>
    @endif

    {{-- En-tête de la page --}}
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">UE : {{ $ue->libelle }}</h1>
        <div>
            <a href="{{ route('academique.ues.edit', $ue) }}" class="btn btn-warning btn-sm shadow-sm">
                <i class="bx bx-edit"></i> Modifier
            </a>
            <a href="{{ route('academique.ues.index') }}" class="btn btn-secondary btn-sm shadow-sm">
